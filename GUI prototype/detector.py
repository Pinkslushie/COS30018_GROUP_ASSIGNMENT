...
class DetectorTF2:
    ...
    def __init__(self, path_to_checkpoint, path_to_labelmap, class_id=None, threshold=0.5):
        ...
        self.color_map = {
            'Misplacement': (255, 255, 0),  # Yellow color for Misplacement class
            'Out-of-stock': (0, 255, 0)    # Blue color for Out-of-stock class
        }
    ...
    def DisplayDetections(self, image, boxes_list, det_time=None):
        ...
        for idx in range(len(boxes_list)):
            ...
            text = cls + ": " + score
            color = self.color_map.get(cls, (0, 255, 0))  # Default color is green if class not found
